# About
# 
# 1. There are probably more eliquent ways of doing this, however my goal was ease and not perfection :-)  (For example, I could have done both Psalms and Hymns in one script)
...
# Settings
$PsalmsFile = "C:\Users\mdede\Documents\Church\Sound\Slideshows\psalms.docx"
$pptxTemplate = "C:\Users\mdede\Documents\Church\Sound\Slideshows\BOPtemplate.pptx"
$pptxOutputDir = "C:\temp\PsalmsTest"  #Note: Script threw errors for me if this path had spaces.

#Open Word Doc
$wordapp = New-Object -ComObject word.application
$PsalmsDocx = $wordapp.Documents.Open($PsalmsFile)
$wordapp.visible = 'msoTrue'
$Paragraphs = $PsalmsDocx.content.paragraphs
...
ForEach($i in 1..($Paragraphs).count){
    ...
    #If Paragraph text matches text "Psalm" followed by space and 1 or 2 (or 3) digits
    If($Paragraphs[$i].Range.Text -match "Psalm \d{1,2}"){
